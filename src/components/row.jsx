    ...
    <div className='container-fluid bg-dark'>
      ...
      <div className="row align-items-center">
        <div className="col-auto">
          <button className='transparent'><ArrowBackIosOutlinedIcon className='arrowleft' onClick={handlescrollleft}/></button>
        </div>
        ...
        <div className="col-auto">
          <button className='transparent'><ArrowForwardIosOutlinedIcon className='arrowright' onClick={handlescrollright}/></button>
        </div>
      </div>
    </div>
  )
